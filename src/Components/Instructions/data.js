export const instructions = [{
  id: 0,
  group_heading: 'Using the Brass Carrying Case:',
  group_items: [
    {
      id: 0,
  ...
  id: 1,
  group_heading: 'Using the AXIS 2000 Clip:',
  group_items: [
    {
      id: 0,
      ...
      id: 3,
      text: 'When finished, open the spring clip and remove any remaining small amount of paper.',
      orientation: '.right',
    },
  ]
}, {
  id: 1,
  group_heading: 'Cleaning the AXIS 2000:',
  group_items: [
    {
      id: 0,
      text: 'After using your AXIS 2000 a number of times, some resin from the tobacco will build up inside the brass tubing.  Please follow the instructions below to easily clean the inside of tubing so that it will keep from clogging and you can enjoy it’s use for many years.',
      orientation: '.left',
    }, {
      id: 1,
      text: 'Take the cleaning rod supplied with your AXIS 2000  and push it through the tubing.  When it protrudes from the other side, use a paper towel (so you don’t get your hands dirty), and grab the rod and pull it through and out.',
      orientation: '.left',
    }, {
      id: 2,
